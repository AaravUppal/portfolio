<template>
    <footer class="backdrop-blur-sm bg-white/80 dark:bg-gray-900/80 border-t border-gray-200/50 dark:border-gray-700/50 mt-20">
      <div class="max-w-8xl mx-auto px-12  py-16">
        <div class="grid md:grid-cols-4 gap-8">
          <div class="md:col-span-2">
            <h3 class="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
              Aarav Uppal
            </h3>
          ...
          <div>
            <h4 class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Services</h4>
            <ul class="space-y-2">
              <li><span class="text-gray-600 dark:text-gray-300">IT guy</span></li>
              <li><span class="text-gray-600 dark:text-gray-300">Mobile Apps</span></li>
              <li><span class="text-gray-600 dark:text-gray-300">Backend</span></li>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-gray-600 dark:text-gray-300 text-sm">
            © 2025 Aarav Uppal. All rights reserved.
          </p>
          <div class="flex space-x-6 mt-4 md:mt-0">
            <a href="#privacy" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors">Privacy Policy</a>
            <a href="#terms" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
